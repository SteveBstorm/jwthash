...
FROM [dbo].[UserApp]
GO
PRINT N'Création de [dbo].[GenerateSalt]...';
...
AS
BEGIN
	-- Declaration de 3 valeurs
	DECLARE @uuid1 UNIQUEIDENTIFIER, @uuid2 UNIQUEIDENTIFIER;
